...
impl Keypad {
    ...
    fn buttons(ui: &mut Ui, state: &mut State) {
        ui.vertical(|ui| {
            ...
            let size_1x1 = vec2(128.0, 50.0);
            let size_1x2 = vec2(195.0, 50.0);
            ...
            ui.horizontal(|ui| {
                if ui.add_sized(size_1x2, Button::new("0")).clicked() {
                    state.queue_char('0');
                }
                if ui.add_sized(size_1x2, Button::new(".")).clicked() {
                    state.queue_char('.');
                }
            });
            ui.horizontal(|ui| {
                ...
                if ui.add_sized(size_1x2, Button::new("Enter")).clicked() {
